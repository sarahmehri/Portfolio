...
<div class="container" id="bg">
    <div class="jumbotron">
        <h4> <a href="../index.html"> Portfolio<i class="material-icons">person</i></a> </h4>
...
<form id="guestbookform" method="post" action="confirmation.php">
    ...
    <fieldset class="form-group border p-2">
        ...
        <select class="form-control" id="meet" name="meet" >
            ...
            <option id="other" value='other' name = "other">Other</option>
        </select>
        <br>

            <input type="text" class="form-control" id="otherInfo" name='otherInfo'  placeholder="please specify....">
    ...
    <fieldset class="form-group border p-2">
        ...
        <div class="checkbox" >
            <label><input type="checkbox"  value="checkbox" id="checkbox" name="checkbox" >Please add me to your mailing list</label>
        </div> 
